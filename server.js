...
Recipes.create('hot cocoa', ['sugar', 'cocoa', 'milk', 'vanilla']);
Recipes.create('tomato soup', ['tomatoes', 'cream', 'salt', 'pepper']);
Recipes.create('peanutbutter jelly', ['peanut butter', 'jelly', 'bread']);
